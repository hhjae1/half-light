...
아래 추격 장면에서 좀비가 플레이어를 감지하는 순간 **심박음**이 시작되고 **추격 BGM 레이어로 전환**됨(소리는 캡처되지 않으므로 해당 이벤트가 발생하는 플레이 장면으로 대체):

<img src="docs/images/cap_chase.gif" width="640" alt="추격 시 BGM 전환·심박음 재생 순간">
